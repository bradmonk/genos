...
%--------------------------------------------------------- 
% 151-VARIANT HILO SERIAL DELETION
%---------------------------------
% P.datapath = ['/Users/bradleymonk/Documents/MATLAB/GIT/genomics/genos/genos_data/APOE'...
% '/APOE_22_23_24_33_34_44/APOE_22_23_24_33_34_44_HLO_p01-05.mat'];
...
MX.CaHoMu   = STATS.muCAHOMEAN;
MX.CaHoSe   = STATS.seCAHOMEAN;
MX.CaHoHiMu = STATS.muCAHOHIMU;
MX.CaHoHiSe = STATS.seCAHOHIMU;

MX.CoHoMu   = STATS.muCOHOMEAN;
MX.CoHoSe   = STATS.seCOHOMEAN;
MX.CoHoHiMu = STATS.muCOHOHIMU;
MX.CoHoHiSe = STATS.seCOHOHIMU;

MX.ALL = [MX.CaHoMu, MX.CaHoSe, MX.CoHoMu, MX.CoHoSe,...
          MX.CaHoHiMu, MX.CaHoHiSe, MX.CoHoHiMu, MX.CoHoHiSe].*100;


MU.CaHoAl = LOOPDATA.CAHOMEAN(20,1:25);
MU.CaHoMi = (LOOPDATA.CAHOHIMU(20,1:25) + LOOPDATA.CAHOMEAN(20,1:25))./2;
MU.CaHoHi = LOOPDATA.CAHOHIMU(20,1:25);

MU.CoHoAl = LOOPDATA.COHOMEAN(20,1:25);
MU.CoHoMi = (LOOPDATA.COHOHIMU(20,1:25) + LOOPDATA.COHOMEAN(20,1:25))./2;
MU.CoHoHi = LOOPDATA.COHOHIMU(20,1:25);

MU.ALL = [MU.CaHoAl; MU.CaHoMi; MU.CaHoHi;...
          MU.CoHoAl; MU.CoHoMi; MU.CoHoHi].*100;


POP.CaHoAl = ones(1,25);
POP.CaHoMi = (POP.CaHoAl + LOOPDATA.CAHOHIPO(20,1:25))./2;
POP.CaHoHi = LOOPDATA.CAHOHIPO(20,1:25);

POP.CoHoAl = ones(1,25);
POP.CoHoMi = (POP.CoHoAl + LOOPDATA.COHOHIPO(20,1:25))./2;
POP.CoHoHi = LOOPDATA.COHOHIPO(20,1:25);

POP.ALL = [POP.CaHoAl; POP.CaHoMi; POP.CaHoHi;...
          POP.CoHoAl; POP.CoHoMi; POP.CoHoHi].*100;




POP.ALL = [...
    POP.CaHoAlPo, POP.CaHoAlSe, POP.CaHoMiPo, POP.CaHoMiSe, POP.CaHoHiPo, POP.CaHoHiSe,...
    POP.CaHoAlPo, POP.CaHoAlSe, POP.CaHoMiPo, POP.CaHoMiSe, POP.CaHoHiPo, POP.CaHoHiSe,...
 ];
