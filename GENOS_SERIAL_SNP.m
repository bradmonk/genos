...
P.Output_Path = [P.data P.f 'SERIAL' P.f 'RUN3' P.f 'MAT'];
...
%     end
    ...
    for nn = 1:numel(BADGENES)
        ...
        %APOE_CHRPOS = [190045411941; 190045412079];
        %VLOCI.TRFISHP( sum(VLOCI.CHRPOS == (APOE_CHRPOS') ,2)>0 ) = 1e-200;
