...
P.serial.DIRroot = [P.home P.f 'genos_data' P.f 'SERIAL' P.f 'ONEHOT'];
...
% SET PATH VARIABLES
%------------------------------------------------------
P.serial.DIRroot = [P.home P.f 'genos_data' P.f 'SERIAL' P.f 'RUNRAND'];
P.serial.DIRmat  = [P.serial.DIRroot P.f 'MAT'];
P.serial.DIRimg  = [P.serial.DIRroot P.f 'IMG'];
P.serial.DIRout  = [P.serial.DIRroot P.f 'OUT'];
...
%----------------
iPHEN  = ADSP.PHEN;
iPHEN.PVX = nan(size(iPHEN,1),P.nHOT);
iPHEN.REF = nan(size(iPHEN,1),P.nHOT);
iPHEN.ALT = nan(size(iPHEN,1),P.nHOT);
iPHEN.DIF = nan(size(iPHEN,1),P.nHOT);
...
% jPHEN (10910 x 10*2 x 3)
%----------------
jPHEN = ADSP.PHEN;
jPHEN.PVX = nan(size(jPHEN,1),(P.nTarg*2),P.LoopsPerSet);
jPHEN.REF = nan(size(jPHEN,1),(P.nTarg*2),P.LoopsPerSet);
jPHEN.ALT = nan(size(jPHEN,1),(P.nTarg*2),P.LoopsPerSet);
...
%----------------
kPHEN = ADSP.PHEN;
kPHEN.PVX = nan(size(kPHEN,1),(P.nTarg*2));
kPHEN.REF = nan(size(kPHEN,1),(P.nTarg*2));
kPHEN.ALT = nan(size(kPHEN,1),(P.nTarg*2));
kPHEN.DIF = nan(size(kPHEN,1),(P.nTarg*2));
...
save([P.serial.DIRout P.f 'SNPRAND.mat'],'iSNP','iLOC','LOOP','-v6')
