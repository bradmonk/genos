...
P.Output_Path = [P.data P.f 'modSNP' P.f 'RUN8_REAL' P.f 'MAT'];
...
%     end
    ...
    s = (1*P.TargetSNPs-(P.TargetSNPs-1)):(1*P.TargetSNPs);
...
LOOPDATA.NNNATh(1:size(NNNATh,1),:,ij) = NNNATh;
...
%==========================================================================
clearvars -except P ADSP INFO SNPTAB PHEN LOCI CASE CTRL USNP LOOPDATA kk ij...
XLOCI XCASE XCTRL XUSNP TRPHE TEPHE
