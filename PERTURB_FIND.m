...
LOOPDATA.PCUT_TR = nan(P.Nloops,6,6);
LOOPDATA.PCUT_HO = nan(P.Nloops,6,6);
...
[CONFU_TR, PERF_TR, AREA_TR] = confusionmx(Yt, VXt, net ,1);
...
XLOCI XCASE XCTRL XUSNP TRPHE TEPHE net nev
...
% HOLDOUT  APOE2:  REF|REF   NNwts(1)|NNwts(1)
% HOLDOUT  APOE4:  REF|REF   NNwts(1)|NNwts(1)
% HOLDOUT TARSNP:  NAT|NAT   NNwts(~)|NNwts(~)
%------------------------------------------------------------------
[PVXt, VXt, DVXt, DXt, Yt, YDt] = vxdx(XLOCI,XCASE,XCTRL,XUSNP,TRPHE,INFO.NNwts);
[PVXh, VXh, DVXh, DXh, Yh, YDh] = vxdx(XLOCI,XCASE,XCTRL,XUSNP,TEPHE,INFO.NNwts);
...
DVXh(:,(e4i*2+8))  = INFO.NNwts(1);
DVXh(:,(e4i*2+9))  = INFO.NNwts(1);
DXh(:,e4i*2-1)     = INFO.NNwts(1);
DXh(:,e4i*2-0)     = INFO.NNwts(1);
PVXh(:,(9+e4i))    = INFO.NNwts(1);
VXh(:,e4i)         = INFO.NNwts(1);
...
% DVXh(:,(vi*2+9))  = INFO.NNwts(1);
% DXh(:,vi*2-1)     = INFO.NNwts(3);
% DXh(:,vi*2-0)     = INFO.NNwts(1);
% PVXh(:,(9+vi))    = INFO.NNwts(3);
% VXh(:,vi)         = INFO.NNwts(3);



% NET: GET ACTIVATIONS FOR TRAINING AND HOLDOUT
[~, ~, ~] = confusionmx(Yt', nev(VXt'));
[~, ~, ~] = confusionmx(Yh', nev(VXh'));
[CONFU_TR, PERF_TR, PCUT_TR, AREA_TR] = nnperform(Yt', DXt', PVXt, net, 'cut',.5,'plt',0);
[CONFU_HO, PERF_HO, PCUT_HO, AREA_HO] = nnperform(Yh', DXh', PVXh, net, 'cut',.5,'plt',0);
...
LOOPDATA.PCUT_TR(ij,:,    1) = PCUT_TR;
LOOPDATA.PCUT_HO(ij,:,    1) = PCUT_HO;
...
% HOLDOUT  APOE2:  REF|REF   NNwts(1)|NNwts(1)
% HOLDOUT  APOE4:  REF|REF   NNwts(1)|NNwts(1)
% HOLDOUT TARSNP:  REF|REF   NNwts(1)|NNwts(1)
%------------------------------------------------------------------
[PVXt, VXt, DVXt, DXt, Yt, YDt] = vxdx(XLOCI,XCASE,XCTRL,XUSNP,TRPHE,INFO.NNwts);
[PVXh, VXh, DVXh, DXh, Yh, YDh] = vxdx(XLOCI,XCASE,XCTRL,XUSNP,TEPHE,INFO.NNwts);
...
%-----------------------------------------------------
vi = find(XLOCI.CHRPOS==CHRPOS);
DVXh(:,(vi*2+8))  = INFO.NNwts(1);
DVXh(:,(vi*2+9))  = INFO.NNwts(1);
DXh(:,vi*2-1)     = INFO.NNwts(1);
DXh(:,vi*2-0)     = INFO.NNwts(1);
PVXh(:,(9+vi))    = INFO.NNwts(1);
VXh(:,vi)         = INFO.NNwts(1);
...
LOOPDATA.PCUT_TR(ij,:,    2) = PCUT_TR;
LOOPDATA.PCUT_HO(ij,:,    2) = PCUT_HO;
...
% HOLDOUT  APOE2:  REF|REF   NNwts(1)|NNwts(1)
% HOLDOUT  APOE4:  REF|REF   NNwts(1)|NNwts(1)
% HOLDOUT TARSNP:  ALT|REF   NNwts(3)|NNwts(1)
%------------------------------------------------------------------
[PVXt, VXt, DVXt, DXt, Yt, YDt] = vxdx(XLOCI,XCASE,XCTRL,XUSNP,TRPHE,INFO.NNwts);
[PVXh, VXh, DVXh, DXh, Yh, YDh] = vxdx(XLOCI,XCASE,XCTRL,XUSNP,TEPHE,INFO.NNwts);
...
LOOPDATA.PCUT_TR(ij,:,    3) = PCUT_TR;
LOOPDATA.PCUT_HO(ij,:,    3) = PCUT_HO;
...
LOOPDATA.PCUT_TR(ij,:,    4) = PCUT_TR;
LOOPDATA.PCUT_HO(ij,:,    4) = PCUT_HO;
...
saveas(gcf, [P.Output_Path P.f GENE '_' num2str(CHRPOS) '_APOE33_SNPXX.png']);
pause(1)
%---------------------------------------------------------------------- 
...
set(gcf, 'PaperPositionMode', 'auto');
%dt=char(datetime(datetime,'Format','yyyy-MM-dd-HH-mm-ss'));
saveas(gcf, [P.Output_Path P.f GENE '_' num2str(CHRPOS) '_APOE33_SNP33.png']);
pause(1)
%---------------------------------------------------------------------- 
...
set(gcf, 'PaperPositionMode', 'auto');
%dt=char(datetime(datetime,'Format','yyyy-MM-dd-HH-mm-ss'));
saveas(gcf, [P.Output_Path P.f GENE '_' num2str(CHRPOS) '_APOE33_SNP34.png']);
pause(1)
%---------------------------------------------------------------------- 
...
set(gcf, 'PaperPositionMode', 'auto');
%dt=char(datetime(datetime,'Format','yyyy-MM-dd-HH-mm-ss'));
saveas(gcf, [P.Output_Path P.f GENE '_' num2str(CHRPOS) '_APOE33_SNP44.png']);
pause(1)
%---------------------------------------------------------------------- 
