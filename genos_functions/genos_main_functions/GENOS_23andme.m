...
[FULLTRX, TRX, TRL] = makennet(VLOCI,VCASE,VCTRL,VUSNP,TRPHE,1);

[FULLTEX, TEX, TEL] = makennet(VLOCI,VCASE,VCTRL,VUSNP,TEPHE,1);
...
MEmu = mean(ME_yp == ME_y);

VLOCI.Beta  = t(2:end);
VLOCI.MEwt  = TTMESNP;
VLOCI.MEact = ME_Act(2:end)';
...
clearvars -except ADSP LOCI CASE CTRL PHEN USNP TRCASE TRCTRL TECASE TECTRL...
VLOCI VCASE VCTRL VUSNP VTRCASE VTRCTRL VTECASE VTECTRL TRPHE TEPHE...
FULLTRX FULLTEX TRX TRL TEX TEL TR_fx TE_fx t TTME TTMESNP
