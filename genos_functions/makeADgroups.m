function [TRCASE,TRCTRL,TECASE,TECTRL] = makeADgroups(PHEN,varargin)
...
clearvars -except ADSP LOCI CASE CTRL PHEN USNP APOES
clc; close all;
...
%-------------------------------------------------------------
clc; clearvars -except ADSP LOCI CASE CTRL PHEN USNP APOES...
...
clearvars -except ADSP LOCI CASE CTRL PHEN USNP APOES PHECASE PHECTRL
