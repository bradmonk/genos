function [HAPLONUM, HAPLOTXT] = makehaplomx(ADMX,CASE,CTRL,USNP,PHE,varargin)
%{
...
HAPLOTXT = [string(ADNN(2:end , 1:6)) HAPLOTXT];

HAPLONUM = [ADNN(2:end , 1:6) HAP];
