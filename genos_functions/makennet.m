function [FULLMX, VX, LX] = makennet(ADMX,CASE,CTRL,USNP,PHE,varargin)
...
ms = min(size(FULLMX));
if ms > 9; disp(int64(FULLMX(1:10,1:10))); else disp(int64(FULLMX(1:ms,1:ms))); end
