...
% MAKE SURE EVERYONE IN CASE.AGE<90 & CTRL.AGE>65
PHETRCASE(PHETRCASE.AGE > 89 , :) = [];
PHETRCTRL(PHETRCTRL.AGE < 65 , :) = [];
PHETECASE(PHETECASE.AGE > 89 , :) = [];
...
%% PREP LABEL MATRICES FOR COHORTS
