function [] = cohcountslive(PHETRCASE,PHETRCTRL,PHETECASE,PHETECTRL,varargin)
...
ax01 = subplot(1,2,1); p1=histogram(TRCTRL,bins); hold on; p2=histogram(TRCASE,bins);
xlabel('Training set N people from cohort (case=red, ctrl=blue)');hold on;
ax02 = subplot(1,2,2); p3=histogram(TECTRL,bins); hold on; p4=histogram(TECASE,bins); 
