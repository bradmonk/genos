function [TRAINMX,TRAINL,TESTMX,TESTL] = makePSEUDOTRAINTESTMX(tR,ADNN,PCTM)
%% makeADTRAINTESTMX.m
...
% STEP-5: DEGRADE TRAINING MATRIX BY MIXING UP CASE/CTRL LABELS

s = size(TRAINL,1);

ss = round(s*PCTM);

TRAINL(1:ss,:) = randi(2,ss,2)-1; % Assign random labels to training set
