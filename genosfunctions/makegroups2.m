function [TRCASE,TRCTRL,TECASE,TECTRL] = makegroups2(PHEN)
...
%-------------------------------------------------------------
%{
% hasBRAAK = ~isnan(PHEN.BRAAK);
% hasBRAAKabove0 = PHEN.BRAAK > 0;
% PHENhasBRAAK = PHEN.COHORTNUM(hasBRAAK);
% BRAAKCOH = unique(PHENhasBRAAK);
% i = ismember(PHEN.COHORTNUM,BRAAKCOH);
% j = PHEN.GOODCOH==1;
% COHSET = PHEN( (i|j) ,:);               % 9486  TOTAL PEOPLE
% size(COHSET)
%}
