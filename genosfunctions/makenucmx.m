function [NUCNUM, NUCTXT] = makenucmx(ADMX,CASE,CTRL,USNP,PHE,varargin)
%{
...
ADNN(2:end , 4)  =  PHE.APOE;               % COL5: APOE
ADNN(2:end , 5)  =  PHE.BRAGE;              % ROW1: BRAAK
ADNN(2:end , 6)  =  PHE.AGEZ;               % COL4: AGE
